...
from alice.physics.square import build_traversal_serpentine, build_traversal_sequential
...
class TestSerpentineOrder:
    ...
    def test_1d_chain(self):
        """1D chain (ly=1) produces sequential serpentine order."""
...
class TestBuildGeometry:
    ...
    def test_returns_geometry_instance(self):
        ...
        geo_cfg = {'lx': 4, 'ly': 3, 'lattice': 'square', 'traverse': 'serpentine'}
    ...
    def test_square_attrs(self):
        ...
        assert geo.traverse == 'serpentine'
...
class TestBuildIntrcmap:
    ...
    def test_default_traverse(self):
        """Missing traverse key defaults to 'serpentine'."""
        geo_cfg = {
            'lx': 3, 'ly': 2,
            'bcx': 'OBC', 'bcy': 'OBC',
            'n2x': True, 'n2y': True, 'n3d': False, 'n3o': False,
