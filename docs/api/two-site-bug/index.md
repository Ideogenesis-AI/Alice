...
|------|-------|-------------|
| `'strang'` | `'second'`, `'2'` | Symmetric second-order step `U_odd(dt/2) U_even(dt) U_odd(dt/2)` |
| `'lie'` | `'first'`, `'1'` | First-order step `U_odd(dt) U_even(dt)` |
